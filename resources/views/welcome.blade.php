...
@section('content')
    ...
    <!-- Stats Section -->
    <section class="py-20 bg-slate-100 dark:bg-slate-950 relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
                <div class="text-center">
                    ...
                    <p class="text-slate-600 dark:text-slate-400 mt-2">Active Shipments</p>
                </div>
                <div class="text-center">
                    <p class="stat-number">120+</p>
                    <p class="text-slate-600 dark:text-slate-400 mt-2">Countries Served</p>
                </div>
                <div class="text-center">
                    <p class="stat-number">99%</p>
                    <p class="text-slate-600 dark:text-slate-400 mt-2">On-Time Rate</p>
                </div>
                <div class="text-center">
                    <p class="stat-number">24/7</p>
                    <p class="text-slate-600 dark:text-slate-400 mt-2">Customer Support</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="features" class="py-24 bg-white dark:bg-slate-900">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                <span class="text-emerald-600 dark:text-emerald-400 font-semibold uppercase tracking-wider text-sm">Features</span>
                <h2 class="text-4xl md:text-5xl font-bold text-slate-900 dark:text-white mt-4 mb-6">Everything You Need</h2>
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <!-- Feature 1 -->
                <div class="feature-card rounded-3xl p-8 bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-white/10">
                    <div class="w-16 h-16 rounded-2xl bg-emerald-500/20 flex items-center justify-center mb-6">
                        <svg class="w-8 h-8 text-emerald-600 dark:text-emerald-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/>
                        </svg>
                    </div>
                    <h3 class="text-xl font-bold text-slate-900 dark:text-white mb-3">Real-Time Tracking</h3>
                    <p class="text-slate-600 dark:text-slate-400">Monitor your shipments 24/7 with live updates and precise location tracking from pickup to delivery.</p>
                </div>
                ...
                <div class="feature-card rounded-3xl p-8 bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-white/10">
                    ...
                    <h3 class="text-xl font-bold text-slate-900 dark:text-white mb-3">Secure & Reliable</h3>
                    <p class="text-slate-600 dark:text-slate-400">Enterprise-grade security with encrypted data, unique tracking IDs, and role-based access control.</p>
                </div>
                ...
                <div class="feature-card rounded-3xl p-8 bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-white/10">
                    ...
                    <h3 class="text-xl font-bold text-slate-900 dark:text-white mb-3">Mobile Optimized</h3>
                    <p class="text-slate-600 dark:text-slate-400">Track shipments on any device. Fully responsive design optimized for desktop, tablet, and mobile.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-24 bg-slate-50 dark:bg-slate-950 relative">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="text-center mb-16">
                <span class="text-emerald-600 dark:text-emerald-400 font-semibold uppercase tracking-wider text-sm">How It Works</span>
                <h2 class="text-4xl md:text-5xl font-bold text-slate-900 dark:text-white mt-4 mb-6">Three Simple Steps</h2>
            </div>
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div class="text-center group">
                    ...
                    <h3 class="text-xl font-bold text-slate-900 dark:text-white mb-3">Create Shipment</h3>
                    <p class="text-slate-600 dark:text-slate-400">Enter sender and receiver details. We automatically generate a unique tracking ID.</p>
                </div>
                ...
                <div class="text-center group">
                    ...
                    <h3 class="text-xl font-bold text-slate-900 dark:text-white mb-3">Share Tracking</h3>
                    <p class="text-slate-600 dark:text-slate-400">Send the tracking ID to your customer. No account required to track shipments.</p>
                </div>
                ...
                <div class="text-center group">
                    ...
                    <h3 class="text-xl font-bold text-slate-900 dark:text-white mb-3">Update Status</h3>
                    <p class="text-slate-600 dark:text-slate-400">Add progress updates as the shipment moves. Customers see real-time changes.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <!-- Footer -->
    <footer class="bg-slate-100 dark:bg-slate-950 border-t border-slate-200 dark:border-slate-800 py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
