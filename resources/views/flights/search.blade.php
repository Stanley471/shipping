...
@section('title', 'Flight Ticket Generator | ' . config('app.name'))

@section('content')
<div class="min-h-screen bg-slate-50 dark:bg-slate-950 pt-20">
    
    <!-- Hero Section -->
    <div class="relative bg-gradient-to-br from-blue-600 to-blue-800 py-20 overflow-hidden">
        <div class="absolute inset-0 opacity-20">
            <div class="absolute inset-0" style="background-image: url('https://images.unsplash.com/photo-1436491865332-7a61a109cc05?w=1920&q=80'); background-size: cover; background-position: center;"></div>
        </div>
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
            <h1 class="text-4xl md:text-5xl font-bold text-white mb-4">Flight Ticket Generator</h1>
            <p class="text-blue-100 text-lg max-w-2xl mx-auto">Search real flights and generate a realistic boarding pass PDF. Perfect for pranks or creative projects!</p>
        </div>
    </div>
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 -mt-10 relative z-20">
                    ...
                    <div class="relative">
                        ...
                        <div class="relative">
                            <input type="text" id="origin" name="origin" placeholder="JFK - New York" 
                                class="w-full px-4 py-3 pl-10 rounded-xl border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-700 text-slate-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent uppercase"
                ...
                <div class="grid md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="date" name="date" 
                            class="w-full px-4 py-3 rounded-xl border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-700 text-slate-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    ...
                    <div>
                        ...
                        <select name="passengers" class="w-full px-4 py-3 rounded-xl border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-700 text-slate-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                            @for($i = 1; $i <= 5; $i++)
        ...
        <div class="mt-12">
            ...
            <div class="grid md:grid-cols-3 gap-4">
                <button onclick="setRoute('JFK', 'LHR')" class="p-4 bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 hover:border-blue-500 dark:hover:border-blue-400 transition-colors text-left">
                ...
                <button onclick="setRoute('LAX', 'DXB')" class="p-4 bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 hover:border-blue-500 dark:hover:border-blue-400 transition-colors text-left">
                    <div class="flex items-center justify-between mb-2">
                ...
                <button onclick="setRoute('SIN', 'HND')" class="p-4 bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 hover:border-blue-500 dark:hover:border-blue-400 transition-colors text-left">
                    <div class="flex items-center justify-between mb-2">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div class="text-center mb-12">
            <h2 class="text-2xl font-bold text-slate-900 dark:text-white mb-4">How It Works</h2>
            <p class="text-slate-500 dark:text-slate-400">Generate a realistic flight ticket in 3 simple steps</p>
        </div>
        <div class="grid md:grid-cols-3 gap-8">
            <div class="text-center">
                ...
                <h3 class="font-semibold text-slate-900 dark:text-white mb-2">Search Flights</h3>
                <p class="text-sm text-slate-500 dark:text-slate-400">Enter your departure, destination, and travel date</p>
            </div>
            <div class="text-center">
                <div class="w-16 h-16 bg-blue-100 dark:bg-blue-900/30 rounded-full flex items-center justify-center mx-auto mb-4">
                    <span class="text-2xl font-bold text-blue-600 dark:text-blue-400">2</span>
                </div>
                <h3 class="font-semibold text-slate-900 dark:text-white mb-2">Select Flight</h3>
                <p class="text-sm text-slate-500 dark:text-slate-400">Choose from real flight options with times and airlines</p>
            </div>
            <div class="text-center">
                <div class="w-16 h-16 bg-blue-100 dark:bg-blue-900/30 rounded-full flex items-center justify-center mx-auto mb-4">
                    <span class="text-2xl font-bold text-blue-600 dark:text-blue-400">3</span>
                </div>
                <h3 class="font-semibold text-slate-900 dark:text-white mb-2">Download Ticket</h3>
                <p class="text-sm text-slate-500 dark:text-slate-400">Get a realistic boarding pass PDF with your details</p>
            </div>
        </div>
    </div>
</div>
