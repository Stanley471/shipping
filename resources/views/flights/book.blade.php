...
@section('page-title', 'Generate Ticket')
...
<div class="max-w-2xl mx-auto">
    ...
    <!-- Breadcrumb -->
    <div class="mb-6">
        <a href="{{ route('flights.search') }}" class="text-emerald-600 dark:text-emerald-400 text-sm hover:underline">← Back to Search</a>
    </div>
    ...
    <div class="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm overflow-hidden">
        ...
        <div class="bg-emerald-600 px-6 py-4">
            ...
            <p class="text-emerald-100 text-sm">Enter passenger details to create your boarding pass</p>
        </div>
            ...
            <form action="{{ route('flights.ticket') }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="passenger_name" required 
                        class="w-full px-4 py-3 rounded-xl border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-700 text-slate-900 dark:text-white focus:ring-2 focus:ring-emerald-500 focus:border-transparent uppercase"
                ...
                <div>
                    ...
                    <div class="grid grid-cols-3 gap-3">
                        <label class="cursor-pointer">
                            ...
                            <div class="p-4 border-2 border-slate-200 dark:border-slate-600 rounded-xl text-center peer-checked:border-emerald-500 peer-checked:bg-emerald-50 dark:peer-checked:bg-emerald-900/20 transition-all hover:border-emerald-300">
