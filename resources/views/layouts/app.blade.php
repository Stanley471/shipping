    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <aside class="hidden lg:flex flex-col w-64 h-full bg-white dark:bg-slate-900 border-r border-slate-200 dark:border-slate-800">
            ...
            <nav class="flex-1 overflow-y-auto py-4 px-3 space-y-1">
                ...
                <!-- Connect Section -->
                <div class="pt-4 mt-4 border-t border-slate-200 dark:border-slate-800">
                    <p class="px-3 text-xs font-semibold text-slate-500 dark:text-slate-500 uppercase tracking-wider mb-2">Connect</p>
                    <a href="{{ config('app.telegram_channel_url') }}" target="_blank" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-colors text-slate-600 dark:text-slate-300 hover:bg-sky-50 dark:hover:bg-sky-900/30 hover:text-sky-600 dark:hover:text-sky-400">
