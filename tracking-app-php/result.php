...
n                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <!-- Chat Support Widget -->
            <?php if (!empty($shipment['chat'])): ?>
            <div class="mt-6 bg-white dark:bg-slate-800 rounded-2xl shadow-lg border border-slate-200 dark:border-slate-700 p-6">
                <div class="flex items-center gap-3 mb-4">
                    ...
                    <div>
                        <h2 class="text-lg font-bold text-slate-900 dark:text-white">Chat with Shipper</h2>
                        <p class="text-sm text-slate-500 dark:text-slate-400">Get real-time updates about your shipment</p>
                    </div>
                </div>
                
                <?php if ($shipment['chat']['provider'] === 'whatsapp'): ?>
                <div class="p-4 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-xl">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <p class="font-semibold text-slate-900 dark:text-white">WhatsApp Chat</p>
                            <p class="text-sm text-slate-500 dark:text-slate-400">Click the chat button to start a conversation</p>
                        </div>
                    </div>
                </div>
                <?php elseif ($shipment['chat']['provider'] === 'smartsupp'): ?>
                <div class="p-4 bg-purple-50 dark:bg-purple-900/20 border border-purple-200 dark:border-purple-800 rounded-xl">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <p class="font-semibold text-slate-900 dark:text-white">SmartSupp Live Chat</p>
                            <p class="text-sm text-slate-500 dark:text-slate-400">Click the chat button to start a conversation</p>
                        </div>
                    </div>
                </div>
                ...
                <!-- Widget Container -->
                <div id="chat-widget-container" class="mt-4"></div>
                ...
                <script>
                    (function() {
                        ...
                        var widgetCode = <?php echo json_encode($shipment['chat']['widget_code']); ?>;
                        
                        // Create a script element to execute the widget code
                        var div = document.createElement('div');
                        div.innerHTML = widgetCode;
                        
                        // Extract and execute scripts
                        var scripts = div.getElementsByTagName('script');
                        var scriptArray = Array.from(scripts);
                        
                        // Remove scripts from div (we'll execute them separately)
